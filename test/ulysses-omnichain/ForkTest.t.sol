...
//     //Fork Test Storage
//     mapping(uint256 => bytes) public hopPayload;
...
//     address lzEndpointAddressArb = address(new MockEndpoint());
//     address lzEndpointAddressAvax = address(new MockEndpoint());
//     address lzEndpointAddressFtm = address(new MockEndpoint());
...
//         arbitrumFork = vm.createFork("https://arbitrum-one.public.blastapi.io");
//         avaxFork = vm.createFork("https://avalanche-c-chain.publicnode.com");
//         ftmFork = vm.createFork("https://endpoints.omniatech.io/v1/fantom/testnet/public");
...
//         vm.deal(address(this), gasLimit + remoteBranchExecutionGas);
